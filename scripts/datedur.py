...
class DateDurationQA():
    def __init__(self, tokenizer, model, device=None):
        ...
        # Other tools
        date_dur_par = ('^(((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+|前|去|今|明|后)(周年|年|岁){0,1}){0,1}'
                '((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+(周){0,1}){0,1}'
                '((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+(个){0,1}(月){0,1}){0,1}'
                '((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+(日|号|天){0,1}){0,1}$')
        date_dur_full = ('^(((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+|前|去|今|明|后)(年|岁)){0,1}'
                         '((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+(个){0,1}月){0,1}'
                         '((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+周年){0,1}'
                         '((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+周){0,1}'
                         '((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+(日|号|天)){0,1}$')
        date_pattern = ('(((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+|前|去|今|明|后)年'
                        '((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+月){0,1}'
                        '((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+(日|号)){0,1}|'
                        '(\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+月'
                        '((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+(日|号)){0,1}|'
                        '(\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+(日|号))')
        dur_pattern = ('((\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+(周年|年|岁)'
                       '|(\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+个月'
                       '|(\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+周'
                       '|(\d|\.|零|一|两|二|三|四|五|六|七|八|九|十)+(日|天))')
